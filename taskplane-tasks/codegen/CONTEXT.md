...
|----------|-------|------------------------------|-------|
| **`_internal.h`** (internal headers) | 58 | ✅ Yes | **CG-054: Now generated** — 56 `_internal.h` rendered (53 impls + 3 classes with internal methods). 5 legacy files are aliases/non-existent models. Constructor args now include correct `const` qualifiers. |
...
- **~187 legacy-only files not generated**: See [Files Not Generated](#files-not-generated-195-legacy-only) for full categorization. Major categories: `_internal.h` (58), `_defs.h/.c` (73 — now generated by CG-053, 161 files covered), build system (6). Interface dispatch `.c` files (8) now generated by CG-051. Remaining gap is primarily `_internal.h` (58 files) and build system files.
