...
def _format_license_java_block(raw: str) -> str:
    """Format raw license text as /* ... */ block (Java/C JNI style)."""
    lines = ["/*"]
...
_LICENSE = ""    # populated by generate_java_files()
_C_LICENSE = ""  # populated by generate_java_files()
...
def generate_java_files(
    ...
    """
    global _LICENSE, _C_LICENSE
    if license_text:
        _LICENSE = _format_license_java_block(license_text)
        _C_LICENSE = _LICENSE
    del repo_root
