...
def _format_license_slash(raw: str) -> str:
    """Format raw license text as // comments (Swift style)."""
    lines = []
...
_SWIFT_LICENSE = ""  # populated by generate_swift_files()
...
def generate_swift_files(
    ...
    """
    global _SWIFT_LICENSE
    if license_text:
        _SWIFT_LICENSE = _format_license_slash(license_text)
