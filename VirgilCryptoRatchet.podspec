Pod::Spec.new do |s|
  ...
  s.dependency "VSCCrypto/Common", "= 0.17.0-dev.3"
  s.dependency "VSCCrypto/Foundation", "= 0.17.0-dev.3"
  s.dependency "VSCCrypto/Ratchet", "= 0.17.0-dev.3"
end
