Pod::Spec.new do |s|
  ...
  s.dependency "VirgilCryptoFoundation", "= 0.17.3-dev.1"
  s.dependency "VSCCrypto/Common", "= 0.17.3-dev.1"
  s.dependency "VSCCrypto/Foundation", "= 0.17.3-dev.1"
  s.dependency "VSCCrypto/Ratchet", "= 0.17.3-dev.1"
end
