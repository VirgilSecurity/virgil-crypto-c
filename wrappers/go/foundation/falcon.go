...
* Import public key from the raw binary format.
*/
func (obj *Falcon) ImportPublicKeyData(keyData []byte, keyAlgInfo AlgInfo) (PublicKey, error) {
    var error C.vscf_error_t
    C.vscf_error_reset(&error)
    keyDataData := helperWrapData (keyData)

    proxyResult := /*pr4*/C.vscf_falcon_import_public_key_data(obj.cCtx, keyDataData, (*C.vscf_impl_t)(unsafe.Pointer(keyAlgInfo.Ctx())), &error)
...
*/
func (obj *Falcon) ExportedPublicKeyDataLen(publicKey PublicKey) uint {
    proxyResult := /*pr4*/C.vscf_falcon_exported_public_key_data_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())))
...
* RFC 3447 Appendix A.1.1.
*/
func (obj *Falcon) ExportPublicKeyData(publicKey PublicKey) ([]byte, error) {
    ...
    proxyResult := /*pr4*/C.vscf_falcon_export_public_key_data(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), outBuf.ctx)
...
* Import private key from the raw binary format.
*/
func (obj *Falcon) ImportPrivateKeyData(keyData []byte, keyAlgInfo AlgInfo) (PrivateKey, error) {
    var error C.vscf_error_t
    C.vscf_error_reset(&error)
    keyDataData := helperWrapData (keyData)

    proxyResult := /*pr4*/C.vscf_falcon_import_private_key_data(obj.cCtx, keyDataData, (*C.vscf_impl_t)(unsafe.Pointer(keyAlgInfo.Ctx())), &error)
...
*/
func (obj *Falcon) ExportedPrivateKeyDataLen(privateKey PrivateKey) uint {
    proxyResult := /*pr4*/C.vscf_falcon_exported_private_key_data_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())))
...
* RFC 3447 Appendix A.1.2.
*/
func (obj *Falcon) ExportPrivateKeyData(privateKey PrivateKey) ([]byte, error) {
    ...
    proxyResult := /*pr4*/C.vscf_falcon_export_private_key_data(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), outBuf.ctx)
