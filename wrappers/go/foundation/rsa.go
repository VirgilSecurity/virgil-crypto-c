...
*/
func (obj *Rsa) GenerateKey(bitlen int) (PrivateKey, error) {
...
*/
func (obj *Rsa) CanEncrypt(publicKey PublicKey, dataLen int) bool {
...
*/
func (obj *Rsa) EncryptedLen(publicKey PublicKey, dataLen int) int {
...
*/
func (obj *Rsa) CanDecrypt(privateKey PrivateKey, dataLen int) bool {
...
*/
func (obj *Rsa) DecryptedLen(privateKey PrivateKey, dataLen int) int {
...
*/
func (obj *Rsa) SignatureLen(privateKey PrivateKey) int {
