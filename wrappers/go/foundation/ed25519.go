...
* Import public key from the raw binary format.
*/
func (obj *Ed25519) ImportPublicKeyData(keyData []byte, keyAlgInfo AlgInfo) (PublicKey, error) {
    var error C.vscf_error_t
    C.vscf_error_reset(&error)
    keyDataData := helperWrapData (keyData)

    proxyResult := /*pr4*/C.vscf_ed25519_import_public_key_data(obj.cCtx, keyDataData, (*C.vscf_impl_t)(unsafe.Pointer(keyAlgInfo.Ctx())), &error)
...
*/
func (obj *Ed25519) ExportedPublicKeyDataLen(publicKey PublicKey) uint {
    proxyResult := /*pr4*/C.vscf_ed25519_exported_public_key_data_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())))
...
* RFC 3447 Appendix A.1.1.
*/
func (obj *Ed25519) ExportPublicKeyData(publicKey PublicKey) ([]byte, error) {
    ...
    proxyResult := /*pr4*/C.vscf_ed25519_export_public_key_data(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), outBuf.ctx)
...
* Import private key from the raw binary format.
*/
func (obj *Ed25519) ImportPrivateKeyData(keyData []byte, keyAlgInfo AlgInfo) (PrivateKey, error) {
    var error C.vscf_error_t
    C.vscf_error_reset(&error)
    keyDataData := helperWrapData (keyData)

    proxyResult := /*pr4*/C.vscf_ed25519_import_private_key_data(obj.cCtx, keyDataData, (*C.vscf_impl_t)(unsafe.Pointer(keyAlgInfo.Ctx())), &error)
...
*/
func (obj *Ed25519) ExportedPrivateKeyDataLen(privateKey PrivateKey) uint {
    proxyResult := /*pr4*/C.vscf_ed25519_exported_private_key_data_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())))
...
* RFC 3447 Appendix A.1.2.
*/
func (obj *Ed25519) ExportPrivateKeyData(privateKey PrivateKey) ([]byte, error) {
    ...
    proxyResult := /*pr4*/C.vscf_ed25519_export_private_key_data(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), outBuf.ctx)
