...
func (obj *RecipientCipher) SetRandom (random IRandom) {
    C.vscf_recipient_cipher_release_random(obj.cCtx)
    C.vscf_recipient_cipher_use_random(obj.cCtx, (*C.vscf_impl_t)(random.ctx()))
}

func (obj *RecipientCipher) SetEncryptionCipher (encryptionCipher ICipher) {
...
func (obj *RecipientCipher) SetSignerHash (signerHash IHash) {
...
*/
func (obj *RecipientCipher) AddKeyRecipient (recipientId []byte, publicKey IPublicKey) {
    recipientIdData := helperWrapData (recipientId)
...
*/
func (obj *RecipientCipher) AddSigner (signerId []byte, privateKey IPrivateKey) error {
...
*/
func (obj *RecipientCipher) StartDecryptionWithKey (recipientId []byte, privateKey IPrivateKey, messageInfo []byte) error {
    recipientIdData := helperWrapData (recipientId)
...
*/
func (obj *RecipientCipher) StartVerifiedDecryptionWithKey (recipientId []byte, privateKey IPrivateKey, messageInfo []byte, messageInfoFooter []byte) error {
    recipientIdData := helperWrapData (recipientId)
    messageInfoData := helperWrapData (messageInfo)
...
*/
func (obj *RecipientCipher) VerifySignerInfo (signerInfo *SignerInfo, publicKey IPublicKey) bool {
