...
type Pkcs8Serializer struct {
    cCtx *C.vscf_pkcs8_serializer_t
}
...
func (obj *Pkcs8Serializer) SerializePublicKeyInplace(publicKey *RawPublicKey) (uint, error) {
    ...
    proxyResult := C.vscf_pkcs8_serializer_serialize_public_key_inplace(obj.cCtx, (*C.vscf_raw_public_key_t)(unsafe.Pointer(publicKey.Ctx())), &error)
...
func (obj *Pkcs8Serializer) SerializePrivateKeyInplace(privateKey *RawPrivateKey) (uint, error) {
    ...
    proxyResult := C.vscf_pkcs8_serializer_serialize_private_key_inplace(obj.cCtx, (*C.vscf_raw_private_key_t)(unsafe.Pointer(privateKey.Ctx())), &error)
...
*/
func newPkcs8SerializerWithCtx(ctx *C.vscf_pkcs8_serializer_t) *Pkcs8Serializer {
    obj := &Pkcs8Serializer {
        cCtx: ctx,
    }
    runtime.SetFinalizer(obj, (*Pkcs8Serializer).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
*/
func newPkcs8SerializerCopy(ctx *C.vscf_pkcs8_serializer_t) *Pkcs8Serializer {
    obj := &Pkcs8Serializer {
...
func (obj *Pkcs8Serializer) SerializedPublicKeyLen(publicKey *RawPublicKey) uint {
    proxyResult := C.vscf_pkcs8_serializer_serialized_public_key_len(obj.cCtx, (*C.vscf_raw_public_key_t)(unsafe.Pointer(publicKey.Ctx())))
...
func (obj *Pkcs8Serializer) SerializePublicKey(publicKey *RawPublicKey) ([]byte, error) {
    ...
    proxyResult := C.vscf_pkcs8_serializer_serialize_public_key(obj.cCtx, (*C.vscf_raw_public_key_t)(unsafe.Pointer(publicKey.Ctx())), outBuf.ctx)
...
func (obj *Pkcs8Serializer) SerializedPrivateKeyLen(privateKey *RawPrivateKey) uint {
    proxyResult := C.vscf_pkcs8_serializer_serialized_private_key_len(obj.cCtx, (*C.vscf_raw_private_key_t)(unsafe.Pointer(privateKey.Ctx())))
...
func (obj *Pkcs8Serializer) SerializePrivateKey(privateKey *RawPrivateKey) ([]byte, error) {
    ...
    proxyResult := C.vscf_pkcs8_serializer_serialize_private_key(obj.cCtx, (*C.vscf_raw_private_key_t)(unsafe.Pointer(privateKey.Ctx())), outBuf.ctx)
