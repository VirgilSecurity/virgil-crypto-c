...
const (
	RandomPaddingPaddingSizeLen uint32 = 4
	RandomPaddingPaddingLenMin  uint32 = RandomPaddingPaddingSizeLen + 1
)
 ...
 */
func (obj *RandomPadding) PaddedDataLen(dataLen uint32) uint32 {
 ...
 */
func (obj *RandomPadding) Len() uint32 {
 ...
 */
func (obj *RandomPadding) LenMax() uint32 {
...
func (obj *RandomPadding) ProcessPaddedData(data []byte) []byte {
	outBuf, outBufErr := bufferNewBuffer(len(data))
	if outBufErr != nil {
		return nil
	}
	defer outBuf.Delete()
