...
func (obj *Ecc) SetupDefaults() error {
    proxyResult := C.vscf_ecc_setup_defaults(obj.cCtx)
...
func (obj *Ecc) GenerateKey(algId AlgId) (PrivateKey, error) {
    ...
    proxyResult := C.vscf_ecc_generate_key(obj.cCtx, C.vscf_alg_id_t(algId), &error)
...
*/
func newEccWithCtx(ctx *C.vscf_ecc_t) *Ecc {
    obj := &Ecc {
        cCtx: ctx,
    }
    runtime.SetFinalizer(obj, (*Ecc).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
*/
func newEccCopy(ctx *C.vscf_ecc_t) *Ecc {
    obj := &Ecc {
...
func (obj *Ecc) GenerateEphemeralKey(key Key) (PrivateKey, error) {
    ...
    proxyResult := C.vscf_ecc_generate_ephemeral_key(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(key.Ctx())), &error)
...
func (obj *Ecc) ImportPublicKey(rawKey *RawPublicKey) (PublicKey, error) {
    ...
    proxyResult := C.vscf_ecc_import_public_key(obj.cCtx, (*C.vscf_raw_public_key_t)(unsafe.Pointer(rawKey.Ctx())), &error)
...
func (obj *Ecc) ExportPublicKey(publicKey PublicKey) (*RawPublicKey, error) {
    ...
    proxyResult := C.vscf_ecc_export_public_key(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), &error)
...
func (obj *Ecc) ImportPrivateKey(rawKey *RawPrivateKey) (PrivateKey, error) {
    ...
    proxyResult := C.vscf_ecc_import_private_key(obj.cCtx, (*C.vscf_raw_private_key_t)(unsafe.Pointer(rawKey.Ctx())), &error)
...
func (obj *Ecc) ExportPrivateKey(privateKey PrivateKey) (*RawPrivateKey, error) {
    ...
    proxyResult := C.vscf_ecc_export_private_key(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), &error)
...
func (obj *Ecc) CanEncrypt(publicKey PublicKey, dataLen uint) bool {
    proxyResult := C.vscf_ecc_can_encrypt(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), (C.size_t)(dataLen))
...
func (obj *Ecc) EncryptedLen(publicKey PublicKey, dataLen uint) uint {
    proxyResult := C.vscf_ecc_encrypted_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), (C.size_t)(dataLen))
...
func (obj *Ecc) Encrypt(publicKey PublicKey, data []byte) ([]byte, error) {
    ...
    proxyResult := C.vscf_ecc_encrypt(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), dataData, outBuf.ctx)
...
func (obj *Ecc) CanDecrypt(privateKey PrivateKey, dataLen uint) bool {
    proxyResult := C.vscf_ecc_can_decrypt(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), (C.size_t)(dataLen))
...
func (obj *Ecc) DecryptedLen(privateKey PrivateKey, dataLen uint) uint {
    proxyResult := C.vscf_ecc_decrypted_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), (C.size_t)(dataLen))
...
func (obj *Ecc) Decrypt(privateKey PrivateKey, data []byte) ([]byte, error) {
    ...
    proxyResult := C.vscf_ecc_decrypt(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), dataData, outBuf.ctx)
...
func (obj *Ecc) CanSign(privateKey PrivateKey) bool {
    proxyResult := C.vscf_ecc_can_sign(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())))
...
func (obj *Ecc) SignatureLen(privateKey PrivateKey) uint {
    proxyResult := C.vscf_ecc_signature_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())))
...
func (obj *Ecc) SignHash(privateKey PrivateKey, hashId AlgId, digest []byte) ([]byte, error) {
    ...
    proxyResult := C.vscf_ecc_sign_hash(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), C.vscf_alg_id_t(hashId), digestData, signatureBuf.ctx)
...
func (obj *Ecc) CanVerify(publicKey PublicKey) bool {
    proxyResult := C.vscf_ecc_can_verify(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())))
...
func (obj *Ecc) VerifyHash(publicKey PublicKey, hashId AlgId, digest []byte, signature []byte) bool {
    ...
    proxyResult := C.vscf_ecc_verify_hash(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), C.vscf_alg_id_t(hashId), digestData, signatureData)
...
func (obj *Ecc) ComputeSharedKey(publicKey PublicKey, privateKey PrivateKey) ([]byte, error) {
    ...
    proxyResult := C.vscf_ecc_compute_shared_key(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), sharedKeyBuf.ctx)
...
func (obj *Ecc) SharedKeyLen(key Key) uint {
    proxyResult := C.vscf_ecc_shared_key_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(key.Ctx())))
...
func (obj *Ecc) KemSharedKeyLen(key Key) uint {
    proxyResult := C.vscf_ecc_kem_shared_key_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(key.Ctx())))
...
func (obj *Ecc) KemEncapsulatedKeyLen(publicKey PublicKey) uint {
    proxyResult := C.vscf_ecc_kem_encapsulated_key_len(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())))
...
func (obj *Ecc) KemEncapsulate(publicKey PublicKey) ([]byte, []byte, error) {
    ...
    proxyResult := C.vscf_ecc_kem_encapsulate(obj.cCtx, (*C.vscf_impl_t)(unsafe.Pointer(publicKey.Ctx())), sharedKeyBuf.ctx, encapsulatedKeyBuf.ctx)
...
func (obj *Ecc) KemDecapsulate(encapsulatedKey []byte, privateKey PrivateKey) ([]byte, error) {
    ...
    proxyResult := C.vscf_ecc_kem_decapsulate(obj.cCtx, encapsulatedKeyData, (*C.vscf_impl_t)(unsafe.Pointer(privateKey.Ctx())), sharedKeyBuf.ctx)
