...
type SaltedKdfAlgInfo struct {
    cCtx *C.vscf_salted_kdf_alg_info_t
}
...
func (obj *SaltedKdfAlgInfo) HashAlgInfo() (AlgInfo, error) {
    proxyResult := C.vscf_salted_kdf_alg_info_hash_alg_info(obj.cCtx)
...
func (obj *SaltedKdfAlgInfo) Salt() []byte {
    proxyResult := C.vscf_salted_kdf_alg_info_salt(obj.cCtx)
...
func (obj *SaltedKdfAlgInfo) IterationCount() uint {
    proxyResult := C.vscf_salted_kdf_alg_info_iteration_count(obj.cCtx)
...
*/
func newSaltedKdfAlgInfoWithCtx(ctx *C.vscf_salted_kdf_alg_info_t) *SaltedKdfAlgInfo {
    obj := &SaltedKdfAlgInfo {
        cCtx: ctx,
    }
    runtime.SetFinalizer(obj, (*SaltedKdfAlgInfo).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
*/
func newSaltedKdfAlgInfoCopy(ctx *C.vscf_salted_kdf_alg_info_t) *SaltedKdfAlgInfo {
    obj := &SaltedKdfAlgInfo {
...
func (obj *SaltedKdfAlgInfo) AlgId() AlgId {
    proxyResult := C.vscf_salted_kdf_alg_info_alg_id(obj.cCtx)
