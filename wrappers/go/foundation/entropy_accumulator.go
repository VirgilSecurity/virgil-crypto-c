...
const (
    EntropyAccumulatorSourcesMax int = 15
)
...
*/
func (obj *EntropyAccumulator) AddSource(source EntropySource, threshold int) {
...
*/
func (obj *EntropyAccumulator) Gather(len int) ([]byte, error) {
