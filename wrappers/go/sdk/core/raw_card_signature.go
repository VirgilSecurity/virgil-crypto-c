...
*/
func newRawCardSignatureWithCtx(ctx *C.vssc_raw_card_signature_t /*ct2*/) *RawCardSignature {
    obj := &RawCardSignature {
        cCtx: ctx,
    }
    runtime.SetFinalizer(obj, (*RawCardSignature).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
*/
func newRawCardSignatureCopy(ctx *C.vssc_raw_card_signature_t /*ct2*/) *RawCardSignature {
    obj := &RawCardSignature {
