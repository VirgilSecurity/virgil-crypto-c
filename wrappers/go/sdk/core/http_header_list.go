...
*/
func newHttpHeaderListWithCtx(ctx *C.vssc_http_header_list_t /*ct2*/) *HttpHeaderList {
    obj := &HttpHeaderList {
        cCtx: ctx,
    }
    runtime.SetFinalizer(obj, (*HttpHeaderList).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
*/
func newHttpHeaderListCopy(ctx *C.vssc_http_header_list_t /*ct2*/) *HttpHeaderList {
    obj := &HttpHeaderList {
