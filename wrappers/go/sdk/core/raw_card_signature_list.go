...
*/
func newRawCardSignatureListWithCtx(ctx *C.vssc_raw_card_signature_list_t /*ct2*/) *RawCardSignatureList {
    obj := &RawCardSignatureList {
        cCtx: ctx,
    }
    runtime.SetFinalizer(obj, (*RawCardSignatureList).Delete)
...
* Note. This method is used in generated code only, and SHOULD NOT be used in another way.
*/
func newRawCardSignatureListCopy(ctx *C.vssc_raw_card_signature_list_t /*ct2*/) *RawCardSignatureList {
    obj := &RawCardSignatureList {
