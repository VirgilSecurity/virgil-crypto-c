...
// #cgo LDFLAGS: -L${SRCDIR}/../binaries/lib -lvsc_pythia -lrelic_s -lvsc_foundation -lvsc_foundation_pb -led25519 -lprotobuf-nanopb -lvsc_common -lmbedcrypto
...
func bufferNewBuffer (cap int) (*buffer, error) {
    ...
    if capacity == 0 {
        return nil, &PythiaError{-1,"Buffer with zero capacity is not allowed."}
    }
