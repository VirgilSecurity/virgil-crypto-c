...
let vscCommonBinaryTarget = {
    if (useLocalBinaries) {
        ...
        let vscCommonChecksum = "b191ce83387439797e801f9e963427a10c134a8fe70918f3c4f3d17d395dcb6b"
...
let vscFoundationBinaryTarget = {
    if (useLocalBinaries) {
        ...
        let vscFoundationChecksum = "a15a3185bb83de4a104a252ed0debe846907a1fd637428f8cfd31c4706fbc444"
        return Target.binaryTarget(
            name: "VSCFoundation",
...
let vscRatchetBinaryTarget = {
    if (useLocalBinaries) {
        ...
        let vscRatchetChecksum = "8d1b3a528119cdf463d87869c1029e3cce36017624b93a5d6430f2db04c0775d"
        return Target.binaryTarget(
            name: "VSCRatchet",
